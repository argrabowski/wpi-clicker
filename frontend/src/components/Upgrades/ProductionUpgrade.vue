  ...
  <li class="list-group-item align-items-center">
    <div class="row">
      <div class="col-6">
        ...
        <br />
        <span class="badge bg-danger rounded-pill col-10">Power: $ {{ stats.power }}/sec</span>
        <br />
...
export default {
  ...
  computed: {
    ...mapGetters(["score", "productionUpgradeStats", "productionUpgradeLevels"]),
    stats() {
      return this.productionUpgradeStats[this.index] || {};
    },
    level() {
      return this.productionUpgradeLevels[this.index];
    },
    upgradeCost() {
    ...
    buttonText() {
      return `Hire ${this.stats.unit} ($${this.upgradeCost})`;
    },
    canUpgrade() {
